# Identifying the best beta value now that the population has an initial immune proportion
...
S = 0.845 * N
I = 0.005 * N
R = 0.15 * N # Initially immune population
...
0.036, 0.037, 0.038, 0.039, 0.04, 0.041, 0.042, 0.043, 0.044, 0.045, 0.046, 0.055, 0.056, 0.057, 0.060,]
...
# Attribute the smallest error in the error list with its corresponding index in the list
# of beta values
print(error_list)
